...
class ABCDEF {
	...
	void takeInputFromAFile() throws IOException {
		...
		String path = "C:\\Users\\DELL\\eclipse-workspace\\Practice\\src\\FileHandling\\name.txt";
...
//		}
	...
	void saveOutputIntoAFile() throws IOException {
		...
		try {
			myObj = new FileWriter("C:\\Users\\DELL\\git\\Java_Program\\LearningJava\\src\\Unit_03\\output.txt");
		} catch (IOException e) {
	...
	void saveLogOfProgram() throws IOException {
		...
		try {
			myObj = new FileWriter("C:\\Users\\DELL\\git\\Java_Program\\LearningJava\\src\\Unit_03\\log.txt",true);
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
